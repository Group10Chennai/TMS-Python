...
def getPressureLabel():
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- getPressureLabel %s ",e)
        print ("Failed - ui.py- getPressureLabel  ",e)
...
def getTempLabel():
    ...
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- getTempLabel %s ",e)
        print ("Failed - ui.py- getTempLabel  ",e)
...
def prepareStaticTPScreen():
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- prepareStaticTPScreen %s ",e)
        print ("Failed - ui.py- prepareStaticTPScreen  ",e)
...
def prepareKeyboardPanel():
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- prepareKeyboardPanel %s ",e)
        print ("Failed - ui.py- prepareKeyboardPanel  ",e)
...
def keyboardEvent(event):
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- keyboardEvent %s ",e)
        print ("Failed - ui.py- keyboardEvent  ",e)
...
def scanClickEvent(event):
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- scanClickEvent %s ",e)
        print ("Failed - ui.py- scanClickEvent  ",e)
...
def doneClickEvent(event):
    try:
        ...
        e = sys.exc_info()[0]
        my_logger.error("Failed - ui.py- doneClickEvent %s ",e)
        print ("Failed - ui.py- doneClickEvent  ",e)
